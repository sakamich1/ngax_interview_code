...
class R {
  /// package name: ngax_interview_code
  static const package = "ngax_interview_code";
...
class _R_Image_AssetResource {
  ...
  /// asset: assets/images/bg_dash_box.png
  // ignore: non_constant_identifier_names
  final bg_dash_box =
      const AssetResource("assets/images/bg_dash_box.png", packageName: null);

  /// asset: assets/images/bg_dash_box_L.png
  // ignore: non_constant_identifier_names
  final bg_dash_box_L =
      const AssetResource("assets/images/bg_dash_box_L.png", packageName: null);

  /// asset: assets/images/bg_dash_box_S.png
  // ignore: non_constant_identifier_names
  final bg_dash_box_S =
      const AssetResource("assets/images/bg_dash_box_S.png", packageName: null);

  /// asset: assets/images/bg_header.png
  // ignore: non_constant_identifier_names
  final bg_header =
      const AssetResource("assets/images/bg_header.png", packageName: null);

  /// asset: assets/images/icon_delete.png
  // ignore: non_constant_identifier_names
  final icon_delete =
      const AssetResource("assets/images/icon_delete.png", packageName: null);

  /// asset: assets/images/icon_text_editor.png
  // ignore: non_constant_identifier_names
  final icon_text_editor = const AssetResource(
...
class _R_Image {
  ...
  /// asset: assets/images/bg_dash_box.png
  // ignore: non_constant_identifier_names
  AssetImage bg_dash_box() {
    return AssetImage(asset.bg_dash_box.keyName);
  }

  /// asset: assets/images/bg_dash_box_L.png
  // ignore: non_constant_identifier_names
  AssetImage bg_dash_box_L() {
    return AssetImage(asset.bg_dash_box_L.keyName);
  }

  /// asset: assets/images/bg_dash_box_S.png
  // ignore: non_constant_identifier_names
  AssetImage bg_dash_box_S() {
    return AssetImage(asset.bg_dash_box_S.keyName);
  }
  ...
  /// asset: assets/images/icon_delete.png
  // ignore: non_constant_identifier_names
  AssetImage icon_delete() {
    return AssetImage(asset.icon_delete.keyName);
  }

  /// asset: assets/images/icon_text_editor.png
  // ignore: non_constant_identifier_names
  AssetImage icon_text_editor() {
    return AssetImage(asset.icon_text_editor.keyName);
  }
}
